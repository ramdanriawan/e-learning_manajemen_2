                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="alert alert-info">
                            Waktu boleh mengerjakan latihan adalah saat tombol "MULAI" berwarna hijau..!
                        </div>

                        <div id="btn_mulai">Latihan akan mulai dalam <div id="akan_mulai"></div>
                        </div>

                        <div class="btn btn-danger" id="waktu_" style="margin-top: 20px">
                            Sisa waktu mengikuti latihan <br>
                        ...
                        <!--
            <a href="#" class="btn btn-success btn-lg" id="tbl_mulai" onclick="return konfirmasi_token_latihan(<?php echo $du['id']; ?>)"><i class="fa fa-check-circle"></i> MULAI</a>
