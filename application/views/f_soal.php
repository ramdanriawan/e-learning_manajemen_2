        ...
        <div class="form-group fgsoal">
            ...
            <div class="col-md-10">
                <select name='jenis_soal' class='form-control' required>
                    ...
                    <option value='latihan' <?php if($d['jenis_soal'] == "latihan"): ?> selected <?php endif; ?>>Latihan</option>
                    <option value='ujian' <?php if($d['jenis_soal'] == "ujian"): ?> selected <?php endif; ?>>Ujian</option>
                </select>
            </div>
        </div>
